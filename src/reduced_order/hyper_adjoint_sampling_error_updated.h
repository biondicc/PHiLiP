#ifndef __HYPER_ADJOINT_SAMPLING_ERROR_UPDATED__
#define __HYPER_ADJOINT_SAMPLING_ERROR_UPDATED__
...
class HyperAdjointSamplingErrorUpdated
{
public:
    /// Constructor
    HyperAdjointSamplingErrorUpdated(const PHiLiP::Parameters::AllParameters *const parameters_input,
                     const dealii::ParameterHandler &parameter_handler_input);

    /// Destructor
    ~HyperAdjointSamplingErrorUpdated() {};
