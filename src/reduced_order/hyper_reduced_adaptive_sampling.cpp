...
template <int dim, int nstate>
void HyperreducedAdaptiveSampling<dim, nstate>::outputIterationData(int iteration) const{
...
template <int dim, int nstate>
RowVectorXd HyperreducedAdaptiveSampling<dim, nstate>::getMaxErrorROM() const{
...
template <int dim, int nstate>
void HyperreducedAdaptiveSampling<dim, nstate>::placeInitialSnapshots() const{
...
template <int dim, int nstate>
dealii::LinearAlgebra::distributed::Vector<double> HyperreducedAdaptiveSampling<dim, nstate>::solveSnapshotFOM(const RowVectorXd& parameter) const{
...
template <int dim, int nstate>
Parameters::AllParameters HyperreducedAdaptiveSampling<dim, nstate>::reinitParams(const RowVectorXd& parameter) const{
    // Copy all parameters
...
template <int dim, int nstate>
void HyperreducedAdaptiveSampling<dim, nstate>::configureInitialParameterSpace() const
{
