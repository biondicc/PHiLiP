#ifndef __HYPER_DWR_LS_SAMPLING_ERROR_UPDATED__
#define __HYPER_DWR_LS_SAMPLING_ERROR_UPDATED__
...
class HyperDWRLSSamplingErrorUpdated
{
public:
    /// Constructor
    HyperDWRLSSamplingErrorUpdated(const PHiLiP::Parameters::AllParameters *const parameters_input,
                     const dealii::ParameterHandler &parameter_handler_input);

    /// Destructor
    ~HyperDWRLSSamplingErrorUpdated() {};
